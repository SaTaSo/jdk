...
private:
  ...
  static zaddress no_keepalive_heap_store_slow_path(volatile zpointer* p, zaddress addr);
...
public:
  ...
  static void no_keepalive_store_barrier_on_heap_oop_field(volatile zpointer* p);
};
